...
## 3. What is NOT enforced, and what remained open for the advisor — CLOSED BY TERMINATION

*Nothing below is outstanding. Every item was open at the close of A0.1 and was closed on
2026-08-25 by the advisor's decision to discontinue the addendum before execution. Kept for
the audit trail. See `DENSE_ADDENDUM_DECISION.md`.*
